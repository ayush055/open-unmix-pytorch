...
class OpenUnmix(nn.Module):
    ...
    def __init__(
        ...
        self.pos_encoder1 = PositionalEncoding(self.nb_bins, dropout=0.5)
        encoder_layer1 = nn.TransformerEncoderLayer(d_model=self.nb_bins, nhead=4, dropout=0.5, activation='gelu')
